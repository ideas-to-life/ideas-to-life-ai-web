...
- Corrected “create vs publish” semantics so Antigravity validates and publishes existing artefacts instead of generating new files.
- Standardised deployment paths for experiments (cards + detail pages) and cheat sheets (static HTML under `public/`), and retrofitted earlier deployments to match.
...
- Publishing experiments publicly to increase optionality, while deferring monetisation decisions to the product layer.
- Keeping thread linking editorial and manual for now, trading automation for clarity and control.
...
- [Human–AI workflows](./threads/human-ai-workflows/)
- [From idea to live experiment](./threads/idea-to-live-experiment/)
- [Systems with contracts](./threads/system-with-contracts/)