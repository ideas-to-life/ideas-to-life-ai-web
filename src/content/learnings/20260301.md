...
produces:
  ...
  signals:
    ...
    - "orchestrator-mode-centralisation"
    - "canonical-builder-ownership"
    - "service-layer-infrastructure-leakage"
    - "inferred-llm-usage-not-execution-based"
    - "llm-should-decorate-insights-not-decide-core-positioning"
    - "span-lifecycle-not-reasoned-about-deterministically-observability-incomplete"
    - "remove-duplication-early-prevent-silent-metric-drift"
